...
const otherGames: GameTitle[] = [
  {
    ...
    imageAlt: "Placeholder de jungla y ruinas para Guardian of Light",
  ...
  },
  {
    ...
    imageAlt: "Placeholder de dunas y ruinas para Temple of Osiris",
    mediaLabel: "Placeholder visual",
  ...
  },
  {
    ...
    imageAlt: "Placeholder de templo al atardecer para Lara Croft GO",
    mediaLabel: "Placeholder visual",
